...
export const SECRET_PATTERNS: ReadonlyArray<SecretPattern> = [
	...
	{ id: "athsra-service-token", re: /\bats_[A-Za-z0-9_-]{20,}\b/g, tag: "ats_" },
	...
	{ id: "modfolio-pat", re: /\bmfp_[A-Za-z0-9]+_[A-Za-z0-9]{16,}\b/g, tag: "mfp_" },
	...
	{ id: "github-pat-fine", re: /\bgithub_pat_[A-Za-z0-9_]{30,}\b/g, tag: "github_pat_" },
	...
	{ id: "stripe-restricted", re: /\brk_live_[A-Za-z0-9]{16,}\b/g, tag: "rk_live_" },
...
export function parseSecretAllowlist(text: string): AllowEntry[] {
	...
	if (!Array.isArray(entries)) throw new Error("선언 파일에 `entries` 배열이 없습니다");
	return entries.map((raw, i) => {
		...
		return { file: e.file as string, id: e.id as string, reason: e.reason as string };
	});
}
